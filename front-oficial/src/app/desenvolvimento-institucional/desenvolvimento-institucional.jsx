    ...
    <div>
      ...
      <div className="bg-[radial-gradient(circle_at_center,#7DD2F6,#5295EA)] w-full pt-20 pb-28 text-white">
        ...
        <div className=" max-w-7xl mx-auto px-4">
          ...
          <h3 className="text-3xl font-semibold text-center py-7">MISSÃO</h3>
          <p className="text-lg montserrat-medium">
          ...
          <h3 className="text-3xl font-semibold text-center py-7">VISÃO</h3>
          <p className="text-lg montserrat-medium">
          ...
          <h3 className="text-3xl font-semibold text-center py-7">VALORES</h3>
          <p className="text-lg montserrat-medium">
