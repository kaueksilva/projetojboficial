      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <br />
                <p>
                Ouvidoria – É canal democrático de comunicação e articulação com a Gestão Municipal no sentido de melhorar a qualidade dos serviços de saúde prestados. O (a) cidadão (ã) pode procurar o atendimento da ouvidoria sempre que precisar de alguma informação sobre saúde ou fazer uma sugestão, denúncia, reclamação ou elogio a respeito de algum serviço, programa ou atividade desenvolvida pela secretaria de saúde, ou, ainda, fazer uma solicitação
                </p>
              </div>
        ...
        setorPublico={
          <>
            ...
            <p>
            AV. Barreto de Menezes, s/n, Prazeres, Jaboatão dos Guararapes – PE, 54.330-900. <br/>
            Telefone: (81) 9. 9975-4361 / 3302.4621<br/>
            E-mail : ouvidoria22sms@gmail.com<br/><br/>

            Segunda à Sexta- feira<br/>
            Das 8h às 14h (Presencial)<br/>
            Das 14h às 16h (Apenas telefone)
            </p>
