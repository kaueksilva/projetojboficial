          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                Realizar ação de fiscalização no local do acidente de trânsito ocorrido em via pública, para garantir a segurança e fluidez viária.</p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>

                <p>
                Apresentar CNH e documentos do veículo.
                </p>
                
                <h2 className="font-bold text-blue-800 mt-4">PRINCIPAIS ETAPAS</h2>
                <p>
                O requerente deve prestar informações claras do<br/> local do acidente através da central pelo telefone <br/>(81) 99476-3655. <br/>
                As partes envolvidas no acidente devem permanecer no local até a chegada dos agentes, e/ou do Serviço de Atendimento Móvel de Urgência (SAMU) com documentos de identificação dos condutores e do veículo e dos envolvidos.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                Estando o efetivo à disposição, o tempo de deslocamento da fiscalização até o local.</p>
