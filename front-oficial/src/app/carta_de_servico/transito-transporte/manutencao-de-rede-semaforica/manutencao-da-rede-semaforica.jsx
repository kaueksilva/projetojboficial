            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2><br/>
                  <p>
                  A ação de manutenção deve ocorrer no menor tempo possível, evitando acidente ao pedestre e ao usuário do sistema.<br/><br/>
                  O usuário que constatar problemas na rede semafórica do município, poderá entrar em contato com a Central de Atendimento da SEMOP (Secretaria Executiva de Mobilidade e Ordem Pública) informando o problema e localização do semáforo com defeito.
                  </p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">24 horas a contar da constatação do defeito.</p>
