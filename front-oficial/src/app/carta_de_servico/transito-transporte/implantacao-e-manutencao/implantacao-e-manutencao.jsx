          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>O usuário poderá solicitar a manutenção de sinalização já existente como: faixa de pedestres,  parada, abrigo, terminal, ponto fixo, sinalização elétrica, sinalização vertical, horizontal. Assim como, poderá solicitar Intervenções que garantam a segurança do Pedestre, da Mobilidade e do usuário do sistema, a fim de propor melhorias na mobilidade do município.</p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>

                <p>
                Fornecer informações clara e corretas do local, endereço completo e relatar a situação atual.
                </p>
                
                <h2 className="font-bold text-blue-800 mt-4">PRINCIPAIS ETAPAS</h2>
                <p>
                O usuário deverá entrar em contato com a Central de Atendimento e registrar sua solicitação ou sugestão. Para solicitações de nova sinalização vertical e/ou horizontal, será realizada uma análise de viabilidade. Após verificar as possibilidades é elaborado o projeto e a emissão da ordem de serviços.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                O atendimento é de no máximo 1 hora, a  <br/>depender da quantidade de pessoas sendo  <br/>atendidas no mesmo horário.</p>
