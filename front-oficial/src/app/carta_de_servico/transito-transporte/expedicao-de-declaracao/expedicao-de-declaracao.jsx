            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2>
                  <p>
                  Verificar a via e os possíveis fatores que<br/> acarretaram o acidente, além de coletar o <br/>depoimento das partes envolvidas.
                  </p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p>
                Apenas o proprietário do veículo e/ou o condutor envolvido na ocorrência, ou representante legal, munido de procuração, podem pegar o documento. Mas a solicitação pode ser feita por qualquer pessoa. É necessário apresentar apenas um documento <br/>oficial que identifique a parte envolvida <br/>e só pode ser requisitado presencialmente.
                </p>
...
O atendimento é exclusivamente presencial e  <br/>ocorre nas segundas, terças, quinta e <br/> sextas-feiras das 8h às 13h, na sede da SEMOP.
            </p>
          </>
        }
        duvidas={
