            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2>
                  <p>
                  Emitir credenciais para uso de vagas de <br/>estacionamentos destinadas a idoso, portadores <br/>de deficiência, pessoa com dificuldade de <br/>locomoção e gestante, atendendo ao disposto <br/>nas resoluções 303 e 304 do Conselho Nacional de Trânsito – CONTRAN.
                  </p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p>
                Preenchimento de requerimento e documentação comprobatória de idade, deficiência ou laudo médico <br/>que ateste dificuldade de locomoção, e período de gestação.
                <br/>
                <br/>
                ...
                <a
                    ...
                    href="https://jaboatao.pe.gov.br/wp-content/uploads/2023/07/REQUERIMENTO-PARA-CREDENCIAL-DE-ESTACIONAMENTO.pdf"
                  ...
                  >
                    ...
                    <p> <br/>
                      Encaminhe um e-mail<br/> para gabsemop.pmjg@gmail.com com os seguintes<br/> documentos digitalizados: RG ou CNH <br/>(frente e verso), comprovante de residência <br/>atualizado e número para contato. Se o pedido <br/>for para portadores de deficiência, pessoas com <br/>dificuldade de locomoção ou gestantes, anexe <br/> também um documento que comprove a <br/>deficiência ou um laudo médico que ateste <br/>dificuldade de locomoção e o período de gestação.
                      </p>
