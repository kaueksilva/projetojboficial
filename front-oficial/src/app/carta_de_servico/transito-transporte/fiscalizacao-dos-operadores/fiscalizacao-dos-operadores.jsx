          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                Realizar fiscalização de forma rotineira por agentes de trânsito e transporte.</p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                
                <h2 className="font-bold text-blue-800 mt-4">PRINCIPAIS ETAPAS</h2>
                <p>
                Para a realização de sugestão, reclamação ou <br/>denúncia, o usuário deverá entrar em contato<br/> com a Central de Atendimento SEMOP <br/>(Secretaria Executiva de Mobilidade e Ordem <br/>Pública) por telefone ou presencialmente.
                </p>
