      ...
      <CartaDeServico
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2>
                  <p>
                  A Secretaria Executiva de Mobilidade e Ordem  <br/>Pública é responsável pelo cadastramento e  <br/>vistoria dos operadores e dos veículos  <br/>prestadores de serviço do sistema de transporte público, incluindo veículos de pequeno porte  <br/>(vans e micro-ônibus), ônibus, táxi, moto-táxi e transporte escolar.
                  </p>
                ...
                O permissionário deverá protocolar o requerimento na recepção da SEMOP (Secretaria Executiva de Mobilidade e Ordem Pública), devidamente acompanhado da documentação definida no ato convocatório em vigência.
                  </p>
                <br/>
              ...
              <div className="pl-10 w-full">
                ...
                Não havendo nenhuma pendência na documentação ou reprovação na vistoria do veículo, o serviço é concluído no mesmo dia da solicitação.</p>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4 mb-4">SECRETARIA EXECUTIVA DE MOBILIDADE E <br/>ORDEM PÚBLICA – SEMOP</h2>
            <p>
            Central de Atendimento SEMOP – 81 99476-3655
            </p>
          </>
        }
        duvidas={
