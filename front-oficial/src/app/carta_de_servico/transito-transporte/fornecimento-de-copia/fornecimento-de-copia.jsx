          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                Documento oficial que identifique a parte envolvida.
                </p>
                
                <h2 className="font-bold text-blue-800 mt-4">PRINCIPAIS ETAPAS</h2>
                <p>Solicitação – A solicitação deverá ser realizada de forma presencial de segunda a sexta, exceto nas quartas, das 8h às 13h, na sede da SEMOP ( Secretaria Executiva de Mobilidade e Ordem Pública ). A solicitação poderá ser realizada por qualquer pessoa.
                Entrega do documento – Apenas o proprietário do veículo e/ou o condutor envolvido na ocorrência, ou representante legal, munido de procuração, podem pegar o documento presencialmente.</p>
