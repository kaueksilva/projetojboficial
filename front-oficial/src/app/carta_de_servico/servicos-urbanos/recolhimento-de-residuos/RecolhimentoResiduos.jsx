      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul  >
                  <li className="mb-4">Remoção de podas, entulhos e resíduos domiciliares.</li>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">de 01 a 05 dias</p>
        ...
        setorPublico={
          ...
          <h2 className=" mt-4">Relação de setores públicos onde este serviço é oferecido.</h2>
            <p className="mt-4 mb-4 ">Secretaria Executiva de Serviços Urbanos 
            </p>
