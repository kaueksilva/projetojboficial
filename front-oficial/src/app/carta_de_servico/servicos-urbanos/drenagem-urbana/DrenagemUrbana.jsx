          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul  >
                  <li className="mb-4">Responsável por serviços ligados às questões de saúde pública e meio ambiente, como:
                  <br/>  – Limpeza de canaletas;
                  <br/>– Limpeza de galerias;
                  <br/>– Limpeza de canais.</li>
                 
                </ul>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p className=" mb-4 mt-4">O munícipio poderá entrar em contato com a Gerência de Drenagem Urbana através do tele-atendimento pelos números:
3134-9258/9-9937-3376 (ligação e WhatsApp)
Ou presencialmente a qualquer uma das Regionais de Serviço do município.
                </p>
              
                <h2 className="font-bold text-blue-800 mt-4">
                PRINCIPAIS ETAPAS:
                </h2>
                <p className="mb-4 mt-4">Os serviços são realizados mediante necessidade ou solicitação, obedecendo a programação pré estabelecida.
                </p>
