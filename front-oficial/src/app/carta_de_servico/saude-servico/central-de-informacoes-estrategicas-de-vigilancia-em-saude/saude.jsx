      ...
      <CartaDeServico
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2><br/>
                  <p>Central de informações Estratégicas de Vigilância em Saúde (CIEVS-PE) – É uma unidade componente da Rede Nacional de Monitoramento e Respostas às Emergências em Saúde Pública, que tem por objetivos a articulação de informações entre os diversos setores da saúde pública para uma maior agilidade na redução de riscos em emergências em saúde pública como desastres, epidemia ou ainda no monitoramento contínuo das Doenças de Notificação Compulsória Imediata fica vinculada a Superintendência de Vigilância em Saúde. <br/><br/>

                  Competências:<br/><br/>

                  – Notificar as doenças de notificação compulsória (DNC), surtos e agravos inusitados, conforme legislação vigente em cada esfera de governo;<br/><br/>

                  – Monitorar as emergências em saúde pública de relevância municipal, estadual e nacional, sendo um elemento facilitador na formulação de respostas rápidas e integradas entre o nível central e municipal e entre as diferentes esferas de gestão do Sistema Único de Saúde;</p>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4 mb-4">ENDEREÇO</h2>
            <p>
            Rua Adalberto Coimbra, 250, Jardim Jordão. <br/>
            Jaboatão dos Guararapes.<br/>
            Telefone: 99975 -1640
            </p>
          <iframe className="w-full mt-4 h-[400px] md:h-[600px]" 
          src="https://www.google.com/maps/d/u/1/embed?mid=1ORcftMNYjkSyf8TbVk2kFJSvDXDW7sU&amp;ehbc=2E312F" width="100%" height="600px" 
