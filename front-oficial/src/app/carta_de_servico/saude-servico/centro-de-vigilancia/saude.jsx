            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2><br/>
                  <p>A regulação é o mecanismo de gestão que possibilita que o usuário seja atendido pelos diferentes serviços de saúde especializados da rede própria e conveniada no SUS. A organização, controle, gerenciamento e priorização de acesso e dos fluxos assistenciais ocorre sob gestão da Central de Regulação pela Secretaria Municipal de Saúde.A Central de Regulação possibilita que o usuário acesse os procedimentos ambulatoriais, seja de exames ou consultas especializadas, assim como o referenciamento a serviços da rede hospitalar que demandam maior complexidade.</p>
