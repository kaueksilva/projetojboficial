      ...
      <CartaDeServico
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">DESCRIÇÃO</h2><br/>
                  <p>Centro de Referência em Saúde do Trabalhador (CEREST) – É um local de atendimento especializado em Saúde do Trabalhador. Além de atender diretamente o trabalhador, serve como uma fonte geradora de conhecimento, ou seja, tem condição de indicar se as doenças ou os sintomas das pessoas atendidas estão relacionados com as atividades que elas exercem, na região onde se encontram. Presta assistência especializada aos trabalhadores acometidos por doenças e/ou agravos relacionados ao trabalho; realiza promoção, proteção, recuperação da saúde dos trabalhadores; investiga as condições do ambiente de trabalho utilizando dados epidemiológicos em conjunto com a Vigilância Sanitária. </p>

               
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p className="mb-4 mt-4">Documentos Necessários:</p>
                <li> Carteira de trabalho; </li>
                <li>Carteira de identidade;</li>
                <li>Exames;</li>
                <li>Laudos;</li>
                <li>Atestados médicos relacionados com a doença ou acidente de trabalho.</li>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4 mb-4">SECRETARIA MUNICIPAL DE SAÚDE</h2>
            <p>
            Regional 6, Rua Professor Severiano Tolentino, 224, Piedade. <br/> 
            Das 08:00h até às 17:00 h <br/>
            Telefone: 3342-2208
            </p>
