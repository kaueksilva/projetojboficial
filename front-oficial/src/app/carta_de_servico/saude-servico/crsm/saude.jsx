      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <br />
                <p>
                Centro de Referência da Mulher – Presta assistência de média complexidade às mulheres do município.
                </p>

                <h2 className="font-bold text-blue-800 mt-4">SERVIÇOS OFERECIDOS:</h2> 
                <p className="mb-4"><br/>
                – Tratamento de Lesões; <br/>
                – Colposcopia; <br/>
                – Ultrassonografia;<br/>
                – Atendimento ginecológico;<br/>
                – Mastologia;<br/>
                – Climatério;<br/>
                ...
                – Laqueadura;<br/>
                – Vasectomia;<br/>
                – Inserção e Retirada do DIU.
                </p>

                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p className="mb-4 mt-4">
                A marcação será realizada na Unidade de Saúde mais próxima com encaminhamento do médico. Portando RG e Cartão do SUS
                </p>
        ...
        setorPublico={
          <>
            ...
            <p>
            Rua Domingos Sávio, 119, Piedade.<br/>
