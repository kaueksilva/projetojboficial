          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">
                  Risco de desabamento, deslizamento atingindo imóvel, risco
                  iminente à vida: atendimento imediato. Casos sem risco
                  aparente de deslizamento/desabamento: até 48h{" "}
                </p>
