          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4">Forma de ingresso para os estudantes novatos que desejam estudar na Rede Pública de Ensino da Secretaria Municipal de Educação do Jaboatão dos Guararapes.</li>
                  <a
                ...
                <p className="mt-4">Apresentar um documento de identificação pessoal, preferencialmente o RG (carteira de identidade)</p>
        
                <h2 className="font-bold text-blue-800 mt-4">
                PRINCIPAIS ETAPAS:
                </h2>
                <p className="mb-4">
                Para solicitação do Histórico Escolar, enviar para o e-mail <a href="mailto:normatizacaoescolasextintas@educacao.jaboatao.pe.gov.br" className="hover:underline">normatizacaoescolasextintas@educacao.jaboatao.pe.gov.br</a> as seguintes informações e documentos:<br/>
– Nome e Município da Escola Extinta; <br/>
-Série/Ano(s) cursadas(os) pelo(a) estudante<br/>
– Ano de conclusão;<br/>
– Nome(s) e Município(s) das escolas anteriores (se houver);<br/>
– Cópia do RG ou Certidão de Nascimento;<br/>
– Cópia do Histórico da Escola Anterior (se houver);<br/>
– Telefone para contato.</p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Após a solicitação, o prazo é de 30 (trinta) dias úteis para conclusão do serviço.</p>
        ...
        setorPublico={
          <>
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO - SALA 12</h2>
            <p className="mt-4">
            ...
            Email: <a href="mailto:nucleodenormatizacao@educacao.jaboatao.pe.gov.br" className="hover:underline">nucleodenormatizacao@educacao.jaboatao.pe.gov.br</a>
            </p>
            <a
