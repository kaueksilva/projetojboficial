      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4">Os pais ou responsáveis dos estudantes menores ou os próprios estudantes (quando são maiores de idade) da nossa Rede Pública Municipal, que desejam permanecer na mesma Unidade de Ensino no ano seguinte, devem comparecer a esta instituição, para assinar a renovação de matrícula, entre os meses de setembro e outubro.</li>
                  <a
                ...
                <ul>
                    <li>RG (carteira de identidade) dos pais ou responsáveis.</li>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Entre os meses de setembro e outubro.</p>
                <h2 className="font-bold text-blue-800 mt-4">PÚBLICO ALVO:</h2>
                <p className="mb-4">Pais e/ou responsáveis de estudantes ou estudantes (maiores de idade) da Rede Municipal de Ensino do Jaboatão dos Guararapes</p>
                <h2 className="font-bold text-blue-800 mt-4">
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO </h2>
            ...
            Endereço: Unidade de Ensino na qual o estudante está matriculado.
            </p>
