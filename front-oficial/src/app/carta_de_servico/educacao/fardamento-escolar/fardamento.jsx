      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4">Fardamento escolar.</li>
                  <a
                ...
                <p className="mt-4">Ser estudante da Rede Pública Municipal do Jaboatão dos Guararapes.</p>
                <h2 className="font-bold text-blue-800 mt-4">
                PRINCIPAIS ETAPAS:
                </h2>
                <p className="mt-4">Após o início do ano letivo, as escolas da Rede Municipal de Ensino, recebem o fardamento da Secretaria Municipal de Educação e distribuem para todos os estudantes matriculados. Todos eles recebem dois conjuntos de uniformes. Educação Infantil – os meninos recebem duas camisetas e duas bermudas. Já as meninas recebem duas camisetas e dois shorts-saia. No Ensino Fundamental (1º ao 9º ano) e na EJA, são distribuídas duas camisetas e uma calça por estudante.</p>
              </div>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO </h2>
            ...
            <a href="mailto:cgdedh@educacao.jaboatao.pe.gov.br" className="hover:underline">cgdedh@educacao.jaboatao.pe.gov.br</a><br/>
            </p>
          </>
        }
        duvidas={
