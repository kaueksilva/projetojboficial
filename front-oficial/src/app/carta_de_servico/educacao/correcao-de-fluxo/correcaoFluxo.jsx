      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4">Os estudantes, matriculados nos anos iniciais do Ensino Fundamental (1º ao 5º ano), não alfabetizados, em defasagem idade-ano e os estudantes alfabetizados, em distorção idade-ano, após uma avaliação, são encaminhados para turmas extras nas quais funcionarão dois programas, Se Liga e Acelera Brasil. Os estudantes encaminhados para o Se Liga poderão ser alfabetizados, permitindo, assim, que recuperem o atraso e sigam em frente em seus estudos. Já os estudantes encaminhados para o Acelera Brasil terão a oportunidade de aprender o suficiente para avançar até dois anos escolares.
                ...
                <ul>
                    <li>Se Liga: Ser estudante da nossa Rede, matriculado nas turmas do 1º ao 5º ano do Ensino Fundamental, não estar alfabetizado e estar em defasagem idade-ano. Acelera Brasil: Ser estudante da nossa Rede, estar matriculado nas turmas do 1º ao 5º ano do Ensino Fundamental, estar alfabetizado e estar em defasagem idade-ano.</li>
                ...
                <p className="mt-4">Interessado deverá comparecer na unidade de Ensino na qual o estudante está matriculado. Os Programas têm início logo após o levantamento e a avaliação dos estudantes em distorção idade-ano. A duração do Programa é de 120 dias letivos.</p>
              </div>

              <div className="pl-10 w-full">
                <h2 className="font-bold text-blue-800 mt-4">PREVISÃO:</h2>
                <h2 className="font-bold text-blue-800 mt-4">PÚBLICO ALVO:</h2>
                <p className="mb-4">Estudantes matriculados (1° ao 5° Ano) Rede Pública Municipal de Ensino do Jaboatão dos Guararapes.</p>
                <h2 className="font-bold text-blue-800 mt-4">
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO </h2>
           ...
           <a href="mailto:seligaacelera@educacao.jaboatao.pe.gov.br" className="hover:underline">
           seligaacelera@educacao.jaboatao.pe.gov.br
           </a>
            </p>
            <p className="mt-4 mb-4">
            Endereço: Av. Barreto de Menezes, 1648 – Prazeres
            </p>
            <p className="mt-4 mb-4">Horário de atendimento: 8h às 17h</p>
          </>
        }
        duvidas={
          <>
