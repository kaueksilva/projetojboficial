          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4"> Documento recebido pelo estudante das unidades de ensino da Rede Pública Municipal do Jaboatão dos Guararapes, ao ser transferido para outra unidade de ensino. Este documento é chamado também de transferência definitiva. Nele, estão o histórico e o certificado escolar do estudante.
...
– Entregar toda a documentação exigida no momento da matrícula na escola de origem;<br />
– Ser estudante do Ensino Fundamental (1º ao 9º ano) ou da Educação de Jovens e Adultos – EJA..</li>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Após a solicitação, o prazo é de 60 (sessenta) dias.</p>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO </h2>
            ...
            <p className="mt-4 mb-4">
            Horário: Horário de atendimento da Unidade de Ensino
            </p>
            <a
