      ...
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul >
                  <li className="mb-4">Material escolar.</li>
                  <a
                ...
                <p className="mb-4">
                Após o início do ano letivo, as Unidades de Ensino recebem o material escolar da Secretaria Municipal de Educação e distribuem a todos os estudantes matriculados, geralmente no início do ano letivo.
                </p>
              </div>
        ...
        setorPublico={
          ...
          <h2 className="font-bold text-blue-800 mt-4">SECRETARIA MUNICIPAL DE EDUCAÇÃO </h2>
            ...
            Horário de atendimento: Horário da Unidade de Ensino.
            </p>
            <p className="mt-4 mb-4">
