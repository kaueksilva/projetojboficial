          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul  >
                  <li className="mb-4">Simulação de Cálculo de Aposentadoria – O Instituto de Previdência
                dos Servidores Públicos do Município do Jaboatão dos Guararapes – JABOATÃOPREV
                – é uma Autarquia criada através da Lei 108/2001, com atualizações dadas pelas Leis
                nºs 102//2006, 153/2007, 703/2011, 1.265/2016 e 1.334/2017, e tem a finalidade
                reconhecer o direito e viabilizar o acesso de todos os servidores públicos efetivos da
                Prefeitura Municipal de Jaboatão dos Guararapes e consequentemente, a seus
                dependentes, à aposentadoria e pensão por morte.</li>
                 
                </ul>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS</h2>
                <p className=" mb-4 mt-4">– Cópia do RG e CPF dos envolvidos<br/>
                Ser servidor efetivo estando com sua documentação pessoal ( RG e CPF)
                </p>
                <h2 className="font-bold text-blue-800 mt-4">
                PRINCIPAIS ETAPAS:
                </h2>
                <p className="mb-4 mt-4">O servidor interessado pode se dirigir à sede do JaboatãoPrev, munido de sua
documentação pessoal e solicitar ao funcionário do núcleo previdenciário que
verifique se as condições para sua aposentadoria já estão satisfeitas.
Os tipos de aposentadoria são:</p>
                <h2 className="font-bold text-blue-800 mt-4">
                I – APOSENTADORIAS COMUNS
                </h2>
                <p className="mb-4 mt-4">. Aposentadoria por Incapacidade;<br/>
. Aposentadoria Compulsória;<br/>
. Aposentadoria Voluntária por Idade e Tempo de Contribuição</p>
                <h2 className="font-bold text-blue-800 mt-4">
                II – APOSENTADORIAS COMUNS
                </h2>
                <p className="mb-4 mt-4">. Aposentadoria por Deficiência;<br/>
                . Aposentadoria por Insalubridade;<br/>
                . Aposentadoria Especial de Professor.</p>
                <a
                    className="mt-4 w-full md:w-auto bg-[#004376] text-white py-2 px-4 rounded-lg hover:bg-[#00ACED] transition-colors justify-center flex text-center"
        ...
        setorPublico={
          ...
          <h2 className=" mt-4">Telefone: (81) 3462.4855, (81) 3462.4619 e (81) 99756-0292(whatsapp).</h2>
            ...
            <a className="mailto:beneficio@jaboatao.pe.gov.br" >  beneficio@jaboatao.pe.gov.br</a>
            </p>
            <p className="mt-4 mb-4  hover:underline">
            Horário de atendimento:
            </p>
            <p className="mt-4 mb-4">
            Segunda e Sexta das 08:00 às 13 hrs, mediante agendamento.
            </p>
