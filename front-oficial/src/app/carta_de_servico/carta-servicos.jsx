  ...
  return (
    <div className="w-full">
      ...
      <div className=" pt-10 pb-8 ml-8 mr-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-2 mb-4">
          {/* GESTÃO URBANA */}
          <a
          ...
          >
            <div className="relative w-full h-40 bg-[#003476] bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-2 mb-4">
          ...
          >
            <div className="relative w-full h-40 bg-[#003476] bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
                Regula licenciamento ambiental, controle de poluição e educação
                ambiental.
              </div>
            </div>
          </a>
          ...
          >
            <div className="relative w-full h-40 bg-[#003476] bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
                Promove igualdade de gênero e combate à violência contra a
                mulher.
              </div>
            </div>
          </a>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-2 mb-4">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center transition-opacity duration-500 group-hover:opacity-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
                Recebe manifestações e melhora serviços públicos por meio do
          ...
          >
            <div className="relative w-full h-40 bg-[#003476] bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
                Aborda limpeza, conservação, manejo de resíduos e fornecimento
                de água.
              </div>
            </div>
          </a>
          ...
          >
            <div className="relative w-full h-40 bg-[#003476] bg-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center hover:bg-gradient-to-br hover:from-[#002A66] hover:to-[#377BB5] text-white text-xs opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2">
                Controla a segurança sanitária em alimentos, água e saúde
                pública.
              </div>
            </div>
          </a>
