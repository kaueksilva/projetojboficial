          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul className="  mb-4">
                  <li>O Programa Fortalecendo Laços está vinculado à Secretaria Executiva de Direitos Humanos, da Família e de Política sobre Drogas da Secretaria Municipal de Assistência Social e Cidadania, possui como objetivo atender, acompanhar e realizar grupos com famílias, através da estratégia da prevenção seletiva com grupos que se encontram em situação de vulnerabilidade e tem como princípio estabelecer ações de base comunitária, que favoreçam e contribuam com o desenvolvimento de fatores protetivos e de prevenção relacionados ao consumo de substâncias psicoativas. 
                <br className="mt-4" />
                ...
                Busca ativa;
                  ...
                  <br />
                  Desenvolvimento do Plano Familiar de Acompanhamento;
                  <br />
                  Atividades de grupos; 
                  <br />
                  Articulação e encaminhamentos a rede de serviços. 
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Famílias prioritariamente que tenham em sua composição crianças e adolescentes, que vivenciam situação de vulnerabilidade social e exposição potencial aos riscos do acesso a substâncias psicoativas. </p>
                <h2 className="font-bold text-blue-800 mt-4">
