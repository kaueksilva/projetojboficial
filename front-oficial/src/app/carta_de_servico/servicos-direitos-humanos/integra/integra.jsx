          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <ul className="  mb-4">
                  <li>O Programa INTEGRA está vinculado à Secretaria Executiva de Direitos humanos, da Família e de Política sobre Drogas da Secretaria Municipal de Assistência Social e Cidadania, tem como premissa realizar atendimento itinerante e territorial às pessoas e familiares que se encontram em situação de vulnerabilidade e risco, devido aos prejuízos decorrentes do uso de substâncias psicoativas.
                <br className="mt-4" />
                ...
                Busca ativa;
                  ...
                  Atendimentos;
                  <br />
                Desenvolvimento do Plano Individual de Acompanhamento. 
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Usuários(as) e familiares que vivenciem problemas relacionados ao uso de substâncias psicoativas</p>
                <h2 className="font-bold text-blue-800 mt-4">
