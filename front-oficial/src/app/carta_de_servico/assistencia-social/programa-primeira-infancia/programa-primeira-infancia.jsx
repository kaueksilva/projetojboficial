          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                O Programa Criança Feliz tem como o objetivo de apoiar e acompanhar o desenvolvimento infantil integral na primeira infância, no período compreendido entre 0 a 6 anos, facilitar o acesso da gestante, das crianças na primeira infância e de suas famílias às políticas e aos serviços públicos que necessitam. O serviço é executado por meio de visitas domiciliares semanais, quinzenais ou mensais, sendo estas decorrentes de busca ativa da equipe do serviço e encaminhamentos da saúde e/ou assistência social.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">O público prioritário são gestantes e crianças de até setenta e dois meses e suas
                famílias.</p>
                <h2 className="font-bold text-blue-800 mt-4">
