          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                A Casa de Acolhida Estação Feliz é um serviço de gestão direta do município do Jaboatão dos Guararapes, atua na garantia de retaguarda ao Poder Judiciário para aplicação de medidas protetivas aos adolescentes de 12 a 18 anos incompletos, afastados da família de origem por situações de vulnerabilidade, violação de direitos e/ou violência.
                </p>
                ...
                <p>Acolhida; Prestação de cuidados continuados; Acompanhamento pela equipe técnica do serviço; Encaminhamentos para a rede de serviços que compõem o Sistema de Garantia de Direitos; Articulação com o poder judiciário, especialmente com a Vara da Infância e Juventude; Atendimento às famílias de origem no intuito de reintegração ao poder familiar; entre outras atividades decorrentes das demandas específicas de cada adolescente.</p>
              </div>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Adolescentes de 12 a 18 anos incompletos</p>
                <h2 className="font-bold text-blue-800 mt-4">
        ...
        setorPublico={
          <>
            ...
            <h2 className="font-bold text-blue-800 mt-4">ENDEREÇO:</h2>
                <p>
                Horário de atendimento: 24 horas/dia<br/>
                Endereço: Rua Barão de Amaraji, 190 – Piedade, Jaboatão dos Guararapes.<br/>
                Telefone: (81) 99939-6652
                </p>
            </div>
          </>
        }
