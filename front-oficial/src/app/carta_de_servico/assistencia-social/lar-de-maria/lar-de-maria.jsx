          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                O Lar de Maria é uma organização da Sociedade Civil que executa o serviço de acolhimento institucional enquanto objeto da parceria firmada com a Secretaria Municipal de Assistência Social e Cidadania do Jaboatão dos Guararapes. Atua na garantia de retaguarda ao Poder Judiciário para aplicação de medidas protetivas a crianças de 0 a 12 anos incompletos, afastados da família de origem por situações de
vulnerabilidade, violação de direitos e/ou violência.
                </p>
                <h2 className="font-bold text-blue-800 mt-4">REQUISITOS:</h2>
                <p>Guia de acolhimento, bem documentos pessoais dos adolescentes a serem acolhidos.</p>
                <h2 className="font-bold text-blue-800 mt-4">
                  PRINCIPAIS ETAPAS:
                </h2>
                <p>Acolhida; Prestação de cuidados continuados; Acompanhamento pela equipe técnica do serviço; Encaminhamentos para a rede de serviços que compõem o Sistema de Garantia de Direitos; Articulação com o poder judiciário, especialmente com a Vara da Infância e Juventude; Atendimento às famílias de origem no intuito de reintegração ao poder familiar; entre outras atividades decorrentes das demandas
                específicas de cada adolescente.</p>
              </div>
...
Endereço: Rua Sebastião Alves, 39 – Piedade, CEP: 54400-271 Jaboatão dos
Guararapes/PE.<br/>
Telefone: (81) 3343-7552</p>
