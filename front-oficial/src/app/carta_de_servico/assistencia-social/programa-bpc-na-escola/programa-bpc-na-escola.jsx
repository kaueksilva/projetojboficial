    ...
    <div>
      <CartaDeServico
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                O programa BPC na Escola em questão tem como objetivo garantir o acesso e a permanência na escola de crianças e adolescentes até 18 anos, com deficiência, que recebem o Benefício de Prestação Continuada (BPC), sendo executado por meio do acompanhamento de beneficiários que são apontadas diversas atividades e ações que podem ser feitas para superação das barreiras vivenciadas pelas crianças e adolescentes com deficiência. O BPC na Escola é executado por visitas domiciliares aos beneficiários.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Crianças e adolescentes até 18 anos, com deficiência, que recebem o Benefício de Prestação
                Continuada (BPC).</p>
                <h2 className="font-bold text-blue-800 mt-4">
        ...
        setorPublico={
          <>
            <div>
            <h2 className="font-bold text-blue-800 mt-4"></h2>
                <p></p>
            </div>
          </>
        }
