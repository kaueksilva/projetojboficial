          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                O Abrigo Santa Luzia é uma Organização da Sociedade Civil que executa o serviço de acolhimento institucional enquanto objeto da parceria firmada com a Secretaria Municipal de Assistência Social e Cidadania do Jaboatão dos Guararapes. Atua para mulheres idosas como moradia provisória, e, excepcionalmente, de longa permanência quando esgotadas todas as possibilidades de autossustento e convívio com os familiares, sendo este decorrente de situações de vulnerabilidade, violação de direitos e/ou violência.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Mulheres idosas</p>
                <h2 className="font-bold text-blue-800 mt-4">
...
Endereço: Avenida José da Câmara Vieira, 81 – Sotave/Prazeres, Jaboatão dos
Guararapes.<br />
Telefone: (81) 3479-2212</p>
