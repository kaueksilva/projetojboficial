          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <p>
                A Política de Segurança Alimentar e Nutricional tem como objetivo garantir o direito de todos ao acesso regular e permanente a alimentos de qualidade, em quantidade suficiente sem comprometer o acesso a outras necessidades essenciais. As atividades se dão de forma descentralizada no território municipal a partir de articulação com os serviços socioassistenciais.
                </p>
...
A Família do beneficiário deverá comparecer ao CRAS ou direto na Funerária Santa Paula levando os documentos do falecido – RG/CPF e comprovante de residência de Jaboatão.</p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Usuários dos serviços socioassistenciais.</p>
                <h2 className="font-bold text-blue-800 mt-4">
        ...
        setorPublico={
          <>
            ...
            <h2 className="font-bold text-blue-800 mt-4">ENDEREÇO:</h2>
                <p></p><br />
                <p>Estrada da Batalha, 1200 – Jardim Jordão
