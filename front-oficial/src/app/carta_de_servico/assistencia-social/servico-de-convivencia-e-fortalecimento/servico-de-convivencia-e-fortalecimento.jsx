          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 w-full">
              <div className="pr-10 w-full">
                ...
                <br />
                <p>
                O SCFV é ofertado por meio de atividades grupais, nas quais são realizadas atividades artísticas, culturais, de lazer e esportivas, dentre outras, de acordo com a idade dos usuários; tendo como objetivo fortalecer as relações familiares e comunitárias, além de promover a integração e a troca de experiências entre os participantes, valorizando o sentido de vida coletiva. O SCFV possui um caráter
preventivo, pautado na defesa e na afirmação de direitos, e no desenvolvimento de capacidades dos usuários. O serviço pode ser ofertado nos Centro de Referência da Assistência Social (CRAS) ou em Organizações da Sociedade Civil (OSCs) parceiras distribuídas em todo território municipal.
                </p>
              ...
              <div className="pl-10 w-full">
                ...
                <p className="mb-4">Podem participar crianças, jovens e adultos; pessoas com deficiência; pessoas que
sofreram violência; vítimas de trabalho infantil; jovens e crianças fora da escola;
jovens que cumprem medidas socioeducativas; idosos sem amparo da família e da
comunidade ou sem acesso a serviços sociais; além de outras pessoas inseridas no
Cadastro Único.</p>
